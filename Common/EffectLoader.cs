...
namespace CalamityOverhaul.Common
{
    ...
    public static class EffectLoader
    {
        ...
        public static Asset<Effect> SvcTeleport { get; set; }
        ...
        public static Asset<Effect> FluidPipeFlow { get; set; }
        public static Asset<Effect> FluidPour { get; set; }
        ...
        public static Asset<Effect> KikasaBloodRain { get; set; }
        public static Asset<Effect> KikasaInkSplat { get; set; }
        public static Asset<Effect> KikasaInkSplash { get; set; }
        ...
        public static Asset<Effect> SeaShrimpJet { get; set; }
