...
namespace CalamityOverhaul
{
    ...
    internal static class CWRID
    {
        ...
        public static int Item_CorrodedCaustibow => Get();
        public static int Item_DarkechoGreatbow => Get();
        public static int Item_Drataliornus => Get();
        public static int Item_FlarewingBow => Get();
        public static int Item_Galeforce => Get();
        public static int Item_Goobow => Get();
        public static int Item_HeavenlyGale => Get();
        public static int Item_HoarfrostBow => Get();
        public static int Item_MarksmanBow => Get();
        public static int Item_Monsoon => Get();
        public static int Item_NettlevineGreatbow => Get();
        public static int Item_Phangasm => Get();
        public static int Item_PlanetaryAnnihilation => Get();
        public static int Item_Shellshooter => Get();
        public static int Item_TelluricGlare => Get();
        public static int Item_TheBallista => Get();
        public static int Item_TheMaelstrom => Get();
        public static int Item_Ultima => Get();
        public static int Item_Toxibow => Get();
        public static int Item_VernalBolter => Get();
