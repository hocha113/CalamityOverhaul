// ============================================================================
// DestroyerSlash.fx —— 毁灭者之刃挥砍轨迹着色器
// 视觉语言对齐毁灭者机械蠕虫：分节装甲 + 探测红灯 + 刃缘激光 + 高温余烬
// uv.x: 0=轨迹尾部(旧) → 1=刀刃当前位置(新)
// uv.y: 0=外缘(刀尖扫过的弧线) → 1=内缘(刀柄一侧)
// 输出预乘alpha，配合 BlendState.AlphaBlend 使用（暗色装甲可遮挡背景）
// ============================================================================
