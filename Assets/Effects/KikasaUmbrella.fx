...
//注意:本文件只许 ps-only technique——墨痕拖尾的 vs+ps 拆在 KikasaUmbrellaTrail.fx,
//与 SpriteBatch 批共用一个 Effect 实例的带顶点着色器 technique 会经 MojoShader 的
//current_vert_raw 残留把 transformMatrix 写进精灵顶点着色器的投影寄存器,伞体整批隐形
// ============================================================================
