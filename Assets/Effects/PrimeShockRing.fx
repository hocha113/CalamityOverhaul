// ============================================================================
// PrimeShockRing.fx —— 屏幕空间冲击波环（全屏后处理）
// 采样屏幕并施加径向折射扭曲 + RGB 色散 + 环缘炽光，最多 3 个并发环。
// uImage0 = 当前屏幕快照；无环命中处为纯透传，绝不破坏画面。
// 由 PrimeScreenEffectRender 在 EndCaptureDraw 阶段 ping-pong 调用。
// ============================================================================
