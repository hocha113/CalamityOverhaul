//=============================================================================
// DestroyerTelegraph.fx — 毁灭者预警线能量流动着色器
// ps_3_0 — 在Additive批次内绘制于拉伸白色四边形上, 着色器全权生成图案
// 四边形约定: uv.x 沿线方向(0=起点 → 1=打击方向末端), uv.y 横向
//=============================================================================

float uTime;
float uIntensity;     //整体亮度(含淡入)
float uLockProgress;  //0=追踪期, 0..1=锁定白闪推进
float uAspect;        //长宽比(长度/宽度), 用于保持噪声各向同性
