...
namespace CalamityOverhaul.Content.UIs.SupertableUIs
{
    ...
    public class SynthesisPreviewUI : UIHandle, ICWRLoader
    {
        ...
        private void SetOmigaSnyContent(string[] omigaSnyContent) {
            ...
            if (CWRUI.HoverItem.type == ModContent.ItemType<DarkMatterBall>()) { OmigaSnyContent = SupertableRecipeData.FullItems_DarkMatterBall2; }
        }
        public override void Update() {
            ...
            SetPosition();
            OmigaSnyContent = SupertableRecipeData.FullItems_Null;
