...
namespace CalamityOverhaul.Content.UIs.MainMenuOvers
{
    ...
    internal abstract class BasePortraitUI : UIHandle, ICWRLoader
    {
        ...
        /// <summary>获取悬停光晕颜色(由子类实现)</summary>
        protected abstract Color GetHoverGlowColor();

        /// <summary>获取脉冲颜色(由子类实现)</summary>
        protected abstract Color GetPulseColor();

        /// <summary>从MenuSave加载保存的UI状态(由子类实现)</summary>
        public abstract void LoadSavedState();

        /// <summary>保存当前UI状态到MenuSave(由子类实现)</summary>
        ...
        /// <summary>子类的SetStaticDefaults逻辑</summary>
        protected virtual void OnSetStaticDefaults() { }

        /// <summary>子类的UnLoad逻辑</summary>
