...
namespace CalamityOverhaul.Content.UIs.OverhaulSettings
{
    ...
    /// <summary>世界生成密度存档</summary>
    internal class WorldGenDensitySave : SaveMod
    {
        /// <summary>密度，key=结构名</summary>
        ...
        /// <summary>Config布尔→密度；关→灭绝，开且灭绝→默认</summary>
        ...
        /// <summary>密度→最小距离系数，越大越稀</summary>
    ...
    /// <summary>世界生成设置，结构开关+密度箭头选择</summary>
    internal class WorldGenSettingsCategory : SettingsCategory
    {
        ...
        private static readonly Color[] DensityLevelColors = [
            new(100, 40, 40),    //Extinction暗红
            new(90, 130, 180),   //Rare冷蓝
            new(160, 180, 160),  //Normal灰绿
            new(200, 180, 70),   //Common暖黄
            new(200, 110, 45),   //Flood深橙
            new(200, 55, 55),    //Everywhere亮红
        ];

        /// <summary>箭头点击区，key=ConfigPropertyName</summary>
