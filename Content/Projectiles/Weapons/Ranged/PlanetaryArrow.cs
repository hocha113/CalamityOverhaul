...
namespace CalamityOverhaul.Content.Projectiles.Weapons.Ranged
{
    internal class PlanetaryArrow : ModProjectile
    {
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
                BaseParticle particle = new PRT_Light(Projectile.Center + (Projectile.velocity.UnitVector() * Main.rand.Next(6))
        ...
        public override void OnKill(int timeLeft) {
            ...
            for (int i = 0; i < 20; i = inc + 1) {
                BaseParticle particle = new PRT_HeavenStar(Projectile.Center, dustVel * Main.rand.NextFloat()
