    ...
    internal class ExtremeColdHail : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (Main.rand.NextBool(6)) {
                Projectile.NewProjectileDirect(Projectile.parent(), Projectile.Center, Projectile.velocity * 0.1f, ModContent.ProjectileType<IceExplosion>(), 13, 0, Projectile.owner, 0);
            }
        }
