...
namespace CalamityOverhaul.Content.Projectiles.Weapons.Ranged.HeldProjs.Vanilla
{
    ...
    internal class SnowballCannonHeldProj : BaseFeederGun
    {
        ...
        public override void HanderSpwanDust() {
            ...
            SpawnGunFireDust(ShootPos, ShootVelocity, splNum: 2, dustID1: 76, dustID2: 149, dustID3: 76);
            SpawnGunFireDust(ShootPos, ShootVelocity, splNum: 3, dustID1: 76, dustID2: 149, dustID3: 76);
        }

        public override void FiringShoot() {
            for (int i = 0; i < 5; i++) {
                int proj = Projectile.NewProjectile(Source2, ShootPos, ShootVelocity.RotatedByRandom(0.1f) * Main.rand.NextFloat(0.8f, 1.1f)
