...
namespace CalamityOverhaul.Content.Projectiles.Weapons.Ranged.HeldProjs.Vanilla
{
    internal class OnyxBlasterHeldProj : BaseFeederGun
    {
        ...
        public override void FiringShoot() {
            ...
            int proj = Projectile.NewProjectile(Owner.parent(), GunShootPos, ShootVelocity * 1.5f, ProjectileID.BlackBolt, (int)(WeaponDamage * 0.9f), WeaponKnockback, Owner.whoAmI, 0);
