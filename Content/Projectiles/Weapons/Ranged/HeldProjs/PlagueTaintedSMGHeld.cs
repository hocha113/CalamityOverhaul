...
{
    internal class PlagueTaintedSMGHeld : BaseFeederGun
    {
        ...
        public override void FiringShoot() {
            ...
            Projectile.NewProjectile(Source, ShootPos, ShootVelocity
                , CWRID.Proj_PlagueTaintedProjectile
        ...
        public override void FiringShootR() {
            ...
            for (int i = 0; i < 3; i++) {
                Projectile.NewProjectile(Source2, ShootPos, ShootVelocity.RotatedBy(-0.15f * (i + 1))
                    , CWRID.Proj_PlagueTaintedDrone, WeaponDamage, WeaponKnockback
                    , Owner.whoAmI, 1f, Owner.GetAlchFlask() || Owner.GetSpiritOrigin() ? 1f : 0f);
                Projectile.NewProjectile(Source2, ShootPos, ShootVelocity.RotatedBy(0.15f * (i + 1))
                    , CWRID.Proj_PlagueTaintedDrone, WeaponDamage, WeaponKnockback
                    , Owner.whoAmI, 1f, Owner.GetAlchFlask() || Owner.GetSpiritOrigin() ? 1f : 0f);
            }
