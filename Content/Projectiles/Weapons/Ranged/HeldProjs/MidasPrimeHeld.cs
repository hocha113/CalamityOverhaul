...
{
    internal class MidasPrimeHeld : BaseFeederGun
    {
        ...
        public override void PreInOwner() {
            ...
            if (cashAvailable2 < 100 && !overflow2 || Owner.CountProjectilesOfID(CWRID.Proj_RicoshotCoin) >= 4 || CartridgeHolderUI.Instance.hoverInMainPage) {
                if (!oldRsD && DownRight) {
        ...
        public override void FiringShoot() {
            Projectile.NewProjectile(Source, ShootPos, ShootVelocity
                , CWRID.Proj_MarksmanShot, WeaponDamage, WeaponKnockback, Owner.whoAmI, 0);
        }
        ...
        public override void FiringShootR() {
            if (Type == ModContent.ProjectileType<CrackshotColtHeld>()) {
                ...
                if (overflow || cashAvailable > 1) {
                    ...
                    Projectile.NewProjectile(Source, ShootPos, CWRRef.GetCoinTossVelocity(Owner)
                    , CWRID.Proj_RicoshotCoin
