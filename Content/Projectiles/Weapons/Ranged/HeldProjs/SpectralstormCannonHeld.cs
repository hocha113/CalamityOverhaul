...
{
    internal class SpectralstormCannonHeld : BaseFeederGun
    {
        ...
        public override void FiringShoot() {
            ...
            for (int index = 0; index < 3; ++index) {
                ...
                int soul = Projectile.NewProjectile(Source, ShootPos, velocity, CWRID.Proj_LostSoulFriendly, WeaponDamage, WeaponKnockback, Owner.whoAmI, 2f, 0f);
