...
{
    internal class MG42HeldProj : BaseFeederGun, ISetupData
    {
        ...
        float shootValue;
        void ISetupData.LoadAsset() => masking = CWRUtils.GetT2DAsset(Texture + "_Masking");
        void ISetupData.SetupData() => MG42 = ModContent.ItemType<MG42>();
