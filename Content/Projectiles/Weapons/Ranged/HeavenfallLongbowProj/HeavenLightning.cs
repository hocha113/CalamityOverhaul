    ...
    internal class HeavenLightning : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!CWRUtils.isServer) {
                ...
                PRK_HeavenfallStar spark = new PRK_HeavenfallStar(Projectile.Center, Projectile.velocity, false, 7, outerSparkScale, outerSparkColor);
                ...
                PRK_HeavenfallStar spark2 = new PRK_HeavenfallStar(Projectile.Center, Projectile.velocity, false, 7, innerSparkScale, innerSparkColor);
