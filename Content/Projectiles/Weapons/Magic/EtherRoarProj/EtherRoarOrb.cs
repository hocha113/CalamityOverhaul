...
{
    internal class EtherRoarOrb : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (Projectile.timeLeft % 3 == 0 && Time > 5f && targetDist < 1400f) {
                AltSparkParticle spark = new(Projectile.Center, Projectile.velocity * 0.05f, false, 6, 2.3f, InnerColor);
            ...
            if (Projectile.timeLeft % 3 == 0 && Time > 5f && targetDist < 1400f) {
                LineParticle spark2 = new(Projectile.Center, -Projectile.velocity * 0.05f, false, 6, 1.7f, InnerColor);
            ...
            if (Projectile.owner == Main.myPlayer) {
                for (int i = 0; i < 8; i++) {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity
                        , ModContent.ProjectileType<EtherRoarOrb2>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                }
            }
        }
    }
