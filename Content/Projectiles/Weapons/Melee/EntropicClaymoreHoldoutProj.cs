...
namespace CalamityOverhaul.Content.Projectiles.Weapons.Melee
{
    internal class EntropicClaymoreHoldoutProj : ModProjectile
    {
        ...
        public static void PrepareSlashShader(bool flipped) {
            GameShaders.Misc["CalamityMod:ExobladeSlash"].SetMiscShaderAsset_1(ModContent.Request<Texture2D>(CWRConstant.Masking + "Extra_193"));//"CalamityMod/ExtraTextures/GreyscaleGradients/VoronoiShapes2"
