...
{
    /// <summary>
    /// 炽狱三叉戟：齐射幕的血魔弹体，快而直，命中点燃。ai[0]=档位。<br/>
    /// 淡入完成才有杀伤
    /// </summary>
    internal class JhTridentBolt : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!Main.dedServ && Main.rand.NextBool(6)) {
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.Torch,
                    -Projectile.velocity * 0.12f, 140, default, 1f);
                dust.noGravity = true;
            }
            Lighting.AddLight(Projectile.Center, 0.3f, 0.12f, 0.05f);
        }
        ...
        public override void OnKill(int timeLeft) {
            ...
            for (int i = 0; i < 4; i++) {
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.Torch,
                    Main.rand.NextVector2Circular(2.5f, 2.5f), 100, default, Main.rand.NextFloat(0.9f, 1.4f));
                dust.noGravity = true;
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int i = Projectile.oldPos.Length - 1; i >= 1; i--) {
                ...
                Main.EntitySpriteDraw(tex, pos, null, new Color(255, 120, 60, 70) * (0.35f * fade * opacity),
            ...
            Main.EntitySpriteDraw(tex, drawPos, null, new Color(255, 140, 60, 0) * (0.45f * opacity),
