...
{
    /// <summary>
    /// 径向冰晶碎片：凝晶核提交后放射，直飞微坠、触物即碎、命中挂寒颤。
    /// 出膛短暂淡入且淡入期无判定（公平阀）；原版冰锥贴图实体层 + 同材质拖尾
    /// </summary>
    internal class WastesIceShardProj : ModProjectile
    {
        ...
        /// <summary>每帧微坠</summary>
        private const float ShardGravity = 0.055f;
        /// <summary>命中寒颤时长</summary>
        private const int ChillOnHitFrames = 90;
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info) {
            target.AddBuff(BuffID.Chilled, ChillOnHitFrames);
        }
