...
namespace CalamityOverhaul.Content.GameModes.GodSmith.Weapons.SummonWhips.Schemes
{
    ...
    /// 五层转印。tag 之王地位与五彩鞭体原样保留。<br/>
    /// 处决 = 万华镜：以目标为心展开五道折线斩（各 0.6x，摆角由
    ...
    internal class GsKaleidoscope : GsWhipScheme
    {
        ...
        protected override string GsDescFallback =>
            "Reforged: the tightest beat window, and a missed swing resets all tempo; each scar lights one prism color, and at five colors the next on-beat hit unfolds a kaleidoscope of five prismatic slashes, exposing the victim to guaranteed-crit chances for 5 seconds";
