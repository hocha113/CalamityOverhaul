...
namespace CalamityOverhaul.Content.GameModes.GodSmith.Weapons.Broadswords
{
    ...
    /// 挥起来带 Boing 的高音弹性 ②命中带溅水音 ③拍在着火的目标身上
    /// 会浇灭火焰且该次 +20% 伤害（灭火拍鱼）
    /// </summary>
    internal class GsPurpleClubberfish : GsBroadswordScheme
    {
        ...
        protected override string GsDescFallback =>
            "Reforged: a wide wet slap with massive knockback that drenches whatever it hits; slapping a burning enemy puts the fire out for bonus damage";
    ...
    /// 音高上扬带弹性；命中带溅水音，着火目标被浇灭。ai[0]=拍号 ai[1]=交替符号
    /// </summary>
    internal class GsPurpleClubberfishHeld : GsBroadswordHeldBase
    {
        ...
        /// <summary>本次命中浇灭了火（ModifyHitExtra 置位，OnHitTarget 消费）</summary>
        ...
        protected override void OnHitTarget(NPC target, NPC.HitInfo hit, int damageDone) {
            ...
            //浇灭火焰（RequestBuffRemoval 联机下自带同步），灭火反馈一记浇灭声
            if (dousedFire) {
                dousedFire = false;
