...
{
    /// <summary>
    /// 预警拍收黑（鬼律第十条"有预警"的视觉半边）+ 三阶侵蚀的常驻薄暗角。
    /// 只读本地玩家的 <see cref="WraithPlayer"/>，纯 CPU 像素条带，无着色器依赖。
    /// 心跳音在 WraithPlayer，这里只管画面
    /// </summary>
    internal sealed class WraithOmenRender : UIHandle
    {
        /// <summary>压在常规 HUD 之下、点鬼簿(2)/铭刻仪式(3)之下</summary>
        ...
        public override void Draw(SpriteBatch spriteBatch) {
            ...
            //四缘收黑条带:自屏缘向内逐层叠条,叠加处自然形成二次衰减的渐变
