...
{
    internal class HEBodyAlt : ModNPC
    {
        ...
        public override void AI() {
            ...
            bool shootShadowFireballs = (calamityGlobalNPC_Head.newAI[0] == (float)HEHead.Phase.ShadowFireballSpin && calamityGlobalNPC_Head.newAI[2] > 0f) ||
        ...
        public override void HitEffect(NPC.HitInfo hit) {
            if (NPC.life <= 0) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    Gore.NewGore(NPC.GetSource_Death(), NPC.Center, NPC.velocity, ModLoader.GetMod("CalamityMod").Find<ModGore>("DoT3").Type, 1f);
                }
            }
        }
