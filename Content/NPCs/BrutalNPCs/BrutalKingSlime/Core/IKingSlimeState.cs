...
namespace CalamityOverhaul.Content.NPCs.BrutalNPCs.BrutalKingSlime.Core
{
    ...
    internal abstract class KingSlimeStateBase : VaultState<KingSlimeStateContext>, IKingSlimeState, IBossNetTiming
    {
