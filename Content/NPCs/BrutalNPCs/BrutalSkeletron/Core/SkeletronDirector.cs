namespace CalamityOverhaul.Content.NPCs.BrutalNPCs.BrutalSkeletron.Core
{
    ...
    internal static class SkeletronDirector
    {
        ...
        public static float SpinDashSpeed(bool asura, bool p2) => (asura ? 27f : 23.5f) + (p2 ? 2.5f : 0f);
        ...
        public static float SlamSpeed(bool asura) => asura ? 44f : 38f;
        /// <summary>合拍钳杀合拢速度</summary>
        public static float ClapSpeed(bool asura) => asura ? 42f : 36f;

        /// <summary>幽灵臂扑抓速度</summary>
        public static float GhostLungeSpeed(bool asura) => asura ? 42f : 36f;
        /// <summary>幽灵臂横扫速度</summary>
        public static float GhostSweepSpeed(bool asura) => asura ? 17f : 14f;
        ...
        public static float SnatchSnapSpeed(bool asura) => ClapSpeed(asura) + 6f;
        ...
        public static float FlickSkullSpeed(bool asura) => asura ? 7.6f : 6.8f;
        ...
        public static float ApplauseRingSpeed(bool asura) => asura ? 4.4f : 3.8f;
        #endregion
    }
}
