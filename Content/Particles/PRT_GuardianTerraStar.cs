...
{
    internal class PRT_GuardianTerraStar : BaseParticle
    {
        ...
        public PRT_GuardianTerraStar(Vector2 relativePosition, Vector2 velocity, bool affectedByGravity, int lifetime, float scale, Color color) {
        ...
        public override void AI() {
            Scale *= 0.95f;
            Color = Color.Lerp(InitialColor, Color.White, (float)Math.Pow(LifetimeCompletion, 3D));
            Velocity *= 0.95f;
