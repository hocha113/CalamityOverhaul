...
{
    internal class GuardianTerraStar : BaseParticle
    {
        ...
        public GuardianTerraStar(Vector2 relativePosition, Vector2 velocity, bool affectedByGravity, int lifetime, float scale, Color color) {
