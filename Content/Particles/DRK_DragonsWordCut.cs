...
{
    internal class DRK_DragonsWordCut : BaseParticle
    {
        ...
        public DRK_DragonsWordCut(Vector2 relativePosition, Vector2 velocity, bool affectedByGravity, int lifetime, float scale, Color color) {
