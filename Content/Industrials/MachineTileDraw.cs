...
namespace CalamityOverhaul.Content.Industrials
{
    ...
    internal static class MachineTileDraw
    {
        ...
        internal static void DrawCell(int i, int j, SpriteBatch spriteBatch, int tileType, int rows, bool dimmed) {
            Tile t = Main.tile[i, j];
            int frameXPos = t.TileFrameX;
            int frameYPos = t.TileFrameY;
            //帧内行号:行步距 16+2,底行源高 18
            int srcHeight = frameYPos / 18 % rows == rows - 1 ? 18 : 16;
