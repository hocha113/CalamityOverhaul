...
{
    /// <summary>治疗站瓦片,3x5;复用特斯拉塔瓦片贴图(常规形态帧)并施加暖粉色调</summary>
    internal class HealStationTile : ModTile
    {
        ...
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(200, 130, 150), VaultUtils.GetLocalizedItemName<HealStation>());
        ...
        public override bool CreateDust(int i, int j, ref int type) {
            Dust.NewDust(new Vector2(i, j) * 16f, 16, 16, DustID.PinkTorch);
            return false;
        }
        ...
        public override void MouseOver(int i, int j) {
            Main.LocalPlayer.SetMouseOverByTile(ModContent.ItemType<HealStation>());
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
            ...
            if (!TileProcessorLoader.ByPositionGetTP(point, out HealStationTP tp)) {
                return;
            }
            if (tp.GlowIntensity > 0.05f) {
                r = 0.40f * tp.GlowIntensity;
                g = 0.18f * tp.GlowIntensity;
                b = 0.24f * tp.GlowIntensity;
            }
        }
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            //共用特斯拉塔贴图,乘上系列色调区分机种
            Color drawColor = Lighting.GetColor(i, j).MultiplyRGB(HealStation.Tint);
            ...
            Color glowColor = HealStation.Tint * (0.3f + tp.GlowIntensity * 0.7f);
