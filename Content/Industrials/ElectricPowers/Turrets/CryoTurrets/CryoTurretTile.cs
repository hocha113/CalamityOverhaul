...
{
    /// <summary>冰冻塔瓦片,3x5;复用特斯拉塔瓦片贴图(常规形态帧)并施加冰蓝色调</summary>
    internal class CryoTurretTile : ModTile
    {
        ...
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(110, 160, 200), VaultUtils.GetLocalizedItemName<CryoTurret>());
        ...
        public override bool CreateDust(int i, int j, ref int type) {
            Dust.NewDust(new Vector2(i, j) * 16f, 16, 16, DustID.Frost);
            return false;
        }
        ...
        public override void MouseOver(int i, int j) {
            Main.LocalPlayer.SetMouseOverByTile(ModContent.ItemType<CryoTurret>());
        }

        public override bool RightClick(int i, int j) {
            if (!TileProcessorLoader.AutoPositionGetTP<CryoTurretTP>(i, j, out var tp)) {
                return false;
            }
            tp.RightEvent();
            return true;
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
            ...
            if (!TileProcessorLoader.ByPositionGetTP(point, out CryoTurretTP tp)) {
                return;
            }
            if (tp.GlowIntensity > 0.05f) {
                r = 0.12f * tp.GlowIntensity;
                g = 0.24f * tp.GlowIntensity;
                b = 0.40f * tp.GlowIntensity;
            }
        }
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            //共用特斯拉塔贴图,乘上系列色调区分机种
            Color drawColor = Lighting.GetColor(i, j).MultiplyRGB(CryoTurret.Tint);
            ...
            Color glowColor = CryoTurret.Tint * (0.3f + tp.GlowIntensity * 0.7f);
