...
{
    /// <summary>护盾发生器瓦片,3x5;复用特斯拉塔瓦片贴图(常规形态帧)并施加青紫色调</summary>
    internal class ShieldGeneratorTile : ModTile
    {
        ...
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(130, 120, 200), VaultUtils.GetLocalizedItemName<ShieldGenerator>());
        ...
        public override void MouseOver(int i, int j) {
            Main.LocalPlayer.SetMouseOverByTile(ModContent.ItemType<ShieldGenerator>());
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
            ...
            if (!TileProcessorLoader.ByPositionGetTP(point, out ShieldGeneratorTP tp)) {
                return;
            }
            if (tp.GlowIntensity > 0.05f) {
                r = 0.24f * tp.GlowIntensity;
                g = 0.20f * tp.GlowIntensity;
                b = 0.42f * tp.GlowIntensity;
            }
        }
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            //共用特斯拉塔贴图,乘上系列色调区分机种
            Color drawColor = Lighting.GetColor(i, j).MultiplyRGB(ShieldGenerator.Tint);
            ...
            Color glowColor = ShieldGenerator.Tint * (0.3f + tp.GlowIntensity * 0.7f);
