...
{
    /// <summary>蘑菇农场机瓦片,2x2;复用生命编织者瓦片贴图并施加菌蓝紫色调</summary>
    internal class MushroomFarmerTile : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            Color drawColor = Lighting.GetColor(i, j).MultiplyRGB(MushroomFarmer.Tint);

            if (tp.MachineData.UEvalue < MushroomFarmerTP.PlantCost) {
                drawColor.R /= 2;
                drawColor.G /= 2;
                drawColor.B /= 2;
                drawColor.A = 255;
