...
{
    internal class LifeWeaverTile : ModTile
    {
        ...
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(76, 135, 52), VaultUtils.GetLocalizedItemName<LifeWeaver>());
        ...
        public override void MouseOver(int i, int j) => Main.LocalPlayer.SetMouseOverByTile(ModContent.ItemType<LifeWeaver>());

        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            if (!VaultUtils.SafeGetTopLeft(i, j, out var point)) {
                return false;
            }
            if (!TileProcessorLoader.ByPositionGetTP(point, out LifeWeaverTP lifeWeaver)) {
                return false;
            }
