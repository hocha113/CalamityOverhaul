...
{
    /// <summary>草药农场机瓦片,2x2;复用生命编织者瓦片贴图并施加暖黄色调</summary>
    internal class HerbFarmerTile : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            Color drawColor = Lighting.GetColor(i, j).MultiplyRGB(HerbFarmer.Tint);

            if (tp.MachineData.UEvalue < HerbFarmerTP.PlantCost) {
                drawColor.R /= 2;
                drawColor.G /= 2;
                drawColor.B /= 2;
                drawColor.A = 255;
