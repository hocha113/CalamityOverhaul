...
{
    internal class FluidInjectorTile : ModTile
    {
        ...
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(128, 96, 64), VaultUtils.GetLocalizedItemName<FluidInjector>());
        ...
        public override void MouseOver(int i, int j) {
            ...
            player.cursorItemIconID = ModContent.ItemType<FluidInjector>();
        }
