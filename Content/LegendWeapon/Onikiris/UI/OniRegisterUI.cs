...
namespace CalamityOverhaul.Content.LegendWeapon.Onikiris.UI
{
    ...
    internal sealed class OniRegisterUI : UIHandle, ILocalizedModType
    {
        ...
        public static LocalizedText Ghost1Name { get; private set; }
        public static LocalizedText Ghost1Origin { get; private set; }
        public static LocalizedText Ghost1Power { get; private set; }
        public static LocalizedText Ghost2Name { get; private set; }
        public static LocalizedText Ghost2Origin { get; private set; }
        public static LocalizedText Ghost2Power { get; private set; }
        public static LocalizedText Ghost3Name { get; private set; }
