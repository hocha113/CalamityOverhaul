...
namespace CalamityOverhaul.Content.LegendWeapon.Onikiris.OniDismembers
{
    ...
    internal sealed class OniDismemberRender : RenderHandle
    {
        ...
        private static void CaptureSnapshot(SpriteBatch sb, GraphicsDevice gd, DismemberEntry entry, NPC npc) {
            ...
            Vector2 fakeScreenPos = entry.AnchorCenter - new Vector2(entry.SnapWidth, entry.SnapHeight) * 0.5f;
            ...
            try {
                Main.instance.DrawNPCDirect(sb, npc, entry.BehindTiles, fakeScreenPos);
            }
            catch {
