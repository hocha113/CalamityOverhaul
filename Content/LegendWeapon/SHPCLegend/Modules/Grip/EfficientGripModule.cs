...
namespace CalamityOverhaul.Content.LegendWeapon.SHPCLegend.Modules.Grip
{
    ...
    internal sealed class EfficientGripModule : SHPCModuleItem
    {
        ...
        /// <summary>强化光束标记过期帧，寿命180+余量</summary>
        private const int EmpowerTrackFrames = 720;
        /// <summary>蓝耗兜底，无HeldItem时用</summary>
        ...
        /// <summary>已凝晶胞，仅myPlayer，经星环ai0同步</summary>
        private int cells;
        /// <summary>当前胞能量 0~CellEnergyCost</summary>
        private float cellEnergy;
        /// <summary>星环进度待同步</summary>
        private bool ringDirty;
        /// <summary>上一帧itemAnimation，跳升=新使用</summary>
        private int prevItemAnim;
        /// <summary>左键蓝耗缓存，右键蓄力时GetManaCost被清零</summary>
        private int cachedShotCost = FallbackShotCost;
        /// <summary>强化光束 whoAmI→过期帧，仅owner</summary>
        ...
        /// <summary>命中回收，满胞停收，免蓝无回收</summary>
        ...
        public override void OnPlayerUpdate(Player player) {
            ...
            //非右键帧刷新左键蓝耗缓存，右键期间采样失真；0=免蓝窗口无回收
            ...
            //零损消费，itemAnimation跳升=新使用；免蓝窗口按住不放；蓄力中球封锁
        ...
        /// <summary>是否有仍在蓄力的球，飞行中不算</summary>
        ...
        /// <summary>零损结算，全额退蓝，光束强化/激光引爆</summary>
    ...
    internal sealed class SHPCRecycleCellRingProj : ModProjectile, IAdditiveDrawable
    {
        ...
        /// <summary>进入汇聚，owner端，netUpdate扩散</summary>
        ...
        public override void AI() {
            ...
            //改件自检仅owner，远端HasModule恒false，远端Kill会抖
