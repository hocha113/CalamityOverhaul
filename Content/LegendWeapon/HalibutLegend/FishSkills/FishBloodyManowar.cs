...
namespace CalamityOverhaul.Content.LegendWeapon.HalibutLegend.FishSkills
{
    ...
    /// <summary>血腥水母群控制器，Spawning 血雾中泳出 → Hovering 呼吸游曳 → Converging 屏息聚拢 → Exploding 逐只破裂。 全部水母伞膜经 <see cref="IPrimitiveDrawable"/> 一次索引图元批量提交（shader 缺省时单位侧精灵降级）。 ai[0]=阶段 ai[1]=阶段计时 ai[2]=聚拢进度</summary>
