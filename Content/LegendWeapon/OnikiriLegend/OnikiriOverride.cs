    ...
    internal class OnikiriOverride : ItemOverride, ILocalizedModType
    {
        ...
        public static void LoadWeaponData() {
            ...
            DamageDictionary = new Dictionary<int, int> {
                ...
                {10, 136}, {11, 155}, {12, 173}, {13, 192}, {14, 210},
                {15, 247}, {16, 283}, {17, 320},
                {18, 347}, {19, 373}, {20, 400},
                {21, 430}, {22, 460},
            };
            ...
            BladeScaleDictionary = new Dictionary<int, float> {
                {0, 0.70f}, {1, 0.73f}, {2, 0.76f}, {3, 0.79f}, {4, 0.82f},
                {5, 0.846f}, {6, 0.872f}, {7, 0.898f}, {8, 0.924f}, {9, 0.95f},
                {10, 0.976f}, {11, 1.002f}, {12, 1.028f}, {13, 1.054f}, {14, 1.08f},
                {15, 1.103f}, {16, 1.127f}, {17, 1.15f},
                {18, 1.173f}, {19, 1.197f}, {20, 1.22f},
                {21, 1.235f}, {22, 1.25f},
            };
            FinaleScaleDictionary = new Dictionary<int, float> {
                {0, 0.95f}, {1, 0.955f}, {2, 0.96f}, {3, 0.965f}, {4, 0.97f},
                {5, 0.976f}, {6, 0.982f}, {7, 0.988f}, {8, 0.994f}, {9, 1.00f},
                {10, 1.006f}, {11, 1.012f}, {12, 1.018f}, {13, 1.024f}, {14, 1.03f},
                {15, 1.037f}, {16, 1.043f}, {17, 1.05f},
                {18, 1.057f}, {19, 1.063f}, {20, 1.07f},
                {21, 1.075f}, {22, 1.08f},
            };
        }
