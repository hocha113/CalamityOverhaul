...
namespace CalamityOverhaul.Content.LegendWeapon.OnikiriLegend.UI
{
    ...
    internal static class OniMeiGlyph
    {
        ...
        private static Stroke Serpent(float width) {
            ...
            for (int i = 0; i <= Seg; i++) {
                float t = i / (float)Seg;
                pts[i] = new Vector2(MathF.Sin(t * 3f * MathF.PI) * (0.5f - t * 0.12f), -0.72f + t * 1.44f);
            }
            return new Stroke(pts, width);
        }
        ...
        private static Dictionary<string, Stroke[]> BuildGlyphs() => new() {
            ...
            //风樋:三条渐细的风线,首线末端回卷
            [nameof(MeiKazehi)] = [
                L(0.11f, -0.82f, -0.42f, -0.30f, -0.47f, 0.30f, -0.50f, 0.74f, -0.46f),
                L(0.10f, -0.86f, -0.02f, -0.30f, -0.05f, 0.20f, -0.04f, 0.55f, 0.00f),
                L(0.09f, -0.76f, 0.38f, -0.30f, 0.35f, 0.10f, 0.36f, 0.36f, 0.40f),
                L(0.07f, 0.74f, -0.46f, 0.86f, -0.56f, 0.88f, -0.70f, 0.78f, -0.78f),
            ],
            //血樋:一道粗槽,一缕垂线,三滴渐远
            [nameof(MeiChihi)] = [
            ...
            //不动:剑竖一笔,镡横一笔,两侧火焰各二刻
            [nameof(MeiFudo)] = [
                L(0.17f, 0.00f, -0.82f, 0.00f, 0.72f),
                L(0.11f, -0.26f, -0.34f, 0.26f, -0.36f),
                L(0.09f, -0.34f, 0.10f, -0.60f, -0.24f),
                L(0.09f, -0.30f, 0.46f, -0.56f, 0.16f),
                L(0.09f, 0.34f, 0.02f, 0.60f, -0.32f),
                L(0.09f, 0.30f, 0.40f, 0.56f, 0.08f),
            ],
            //倶利伽罗:剑竖一笔,龙身蛇行盘剑,龙首一凿一颚
            [nameof(MeiKurikara)] = [
                L(0.15f, 0.00f, -0.86f, 0.00f, 0.80f),
                Serpent(0.11f),
                Dot(0.14f, 0.42f, -0.66f),
                L(0.08f, 0.42f, -0.66f, 0.64f, -0.78f),
            ],
        };
