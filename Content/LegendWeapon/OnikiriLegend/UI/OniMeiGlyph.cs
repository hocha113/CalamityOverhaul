...
namespace CalamityOverhaul.Content.LegendWeapon.OnikiriLegend.UI
{
    ...
    internal static class OniMeiGlyph
    {
        ...
        private static Dictionary<string, Stroke[]> BuildGlyphs() => new() {
            ...
            //蜘蛛切:三锚成三角,当中一凿;三角本身就是"墨丝"的读法
            [nameof(MeiKumokiri)] = [
                L(0.11f, -0.72f, -0.58f, 0.70f, -0.10f),
                L(0.11f, 0.70f, -0.10f, -0.24f, 0.66f),
                L(0.11f, -0.24f, 0.66f, -0.72f, -0.58f),
                Dot(0.14f, -0.09f, -0.01f),
            ],
            //鬼丸:一个圆(丸)内含断腕的斜断,外挑一角鬼角
            [nameof(MeiOnimaru)] = [
                Arc(0.11f, 0.00f, 0.02f, 0.62f, 0.00f, 6.28f, 18),
                L(0.14f, -0.42f, 0.40f, 0.44f, -0.36f),
                L(0.10f, -0.46f, -0.44f, -0.72f, -0.80f),
                Dot(0.12f, 0.30f, 0.34f),
            ],
            //雷切:折雷竖劈,中段两道分叉,底一凿钉住落点
            [nameof(MeiRaikiri)] = [
                L(0.13f, -0.10f, -0.86f, 0.16f, -0.34f, -0.18f, 0.06f, 0.12f, 0.62f),
                L(0.08f, 0.16f, -0.34f, 0.60f, -0.52f),
                L(0.08f, -0.18f, 0.06f, -0.62f, 0.00f),
                Dot(0.13f, 0.12f, 0.62f),
            ],
            //鵺切:上一弧(收翅)+向下一竖到底(俯冲)+落地一横
            [nameof(MeiNuekiri)] = [
                Arc(0.10f, 0.00f, -0.50f, 0.46f, 3.35f, 6.07f, 12),
                L(0.14f, 0.00f, -0.34f, 0.00f, 0.50f),
                L(0.13f, -0.52f, 0.62f, 0.52f, 0.62f),
                Dot(0.10f, 0.00f, 0.50f),
            ],
            //紙樋:粗槽+一张竖纸(方框)挂在槽下
            [nameof(MeiKamihi)] = [
                L(0.18f, -0.80f, -0.42f, 0.76f, -0.48f),
                L(0.08f, -0.34f, -0.20f, -0.34f, 0.62f, 0.30f, 0.62f, 0.30f, -0.20f, -0.34f, -0.20f),
                L(0.06f, -0.34f, 0.20f, 0.30f, 0.20f),
            ],
            //空樋:两道断开的槽线(离地),中间一枚浮环
            [nameof(MeiSorahi)] = [
                L(0.12f, -0.84f, -0.44f, -0.26f, -0.48f),
                L(0.12f, 0.26f, -0.48f, 0.84f, -0.42f),
                Arc(0.09f, 0.00f, 0.16f, 0.34f, 0.00f, 6.28f, 14),
                Dot(0.10f, 0.00f, 0.16f),
            ],
            //鏡樋:槽下一面立镜(方框)+一道斜掠高光
            [nameof(MeiKagamihi)] = [
                L(0.17f, -0.78f, -0.50f, 0.74f, -0.54f),
                L(0.09f, -0.40f, -0.22f, -0.40f, 0.64f, 0.36f, 0.64f, 0.36f, -0.22f, -0.40f, -0.22f),
                L(0.07f, -0.28f, 0.52f, 0.24f, -0.10f),
            ],
            //雨樋:斜槽 + 三滴渐次下坠(越下越大)
            [nameof(MeiAmahi)] = [
                L(0.17f, -0.82f, -0.52f, 0.72f, -0.34f),
                Dot(0.09f, -0.44f, 0.02f),
                Dot(0.12f, -0.02f, 0.30f),
                Dot(0.15f, 0.40f, 0.62f),
            ],
            //綴樋:槽下三点被一条折线串起来(缀)
            [nameof(MeiTsuzurihi)] = [
                L(0.17f, -0.80f, -0.52f, 0.76f, -0.56f),
                L(0.07f, -0.62f, 0.10f, -0.10f, 0.46f, 0.42f, 0.06f, 0.76f, 0.44f),
                Dot(0.12f, -0.62f, 0.10f),
                Dot(0.12f, 0.42f, 0.06f),
            ],
            //梵鐘:钟身(倒 U)+钟口一横+撞木一点
            [nameof(MeiBonsho)] = [
                Arc(0.13f, 0.00f, 0.10f, 0.56f, 3.14f, 6.28f, 14),
                L(0.13f, -0.56f, 0.10f, -0.56f, 0.48f),
                L(0.13f, 0.56f, 0.10f, 0.56f, 0.48f),
                L(0.15f, -0.70f, 0.52f, 0.70f, 0.52f),
                Dot(0.12f, 0.00f, -0.62f),
            ],
            //般若:两只上挑的角+一张咧到耳根的嘴,眼位两凿
            [nameof(MeiHannya)] = [
                L(0.12f, -0.52f, -0.22f, -0.78f, -0.80f),
                L(0.12f, 0.52f, -0.22f, 0.78f, -0.80f),
                Dot(0.13f, -0.30f, -0.02f),
                Dot(0.13f, 0.30f, -0.02f),
                L(0.11f, -0.60f, 0.34f, -0.20f, 0.62f, 0.20f, 0.62f, 0.60f, 0.34f),
            ],
            //枯山水:三道同心耙纹弧+一块立石
            [nameof(MeiKaresansui)] = [
                Arc(0.08f, 0.00f, 0.30f, 0.30f, 3.34f, 6.08f, 12),
                Arc(0.08f, 0.00f, 0.30f, 0.56f, 3.34f, 6.08f, 14),
                Arc(0.08f, 0.00f, 0.30f, 0.82f, 3.34f, 6.08f, 16),
                L(0.16f, -0.06f, 0.30f, -0.06f, -0.28f),
                Dot(0.14f, -0.06f, -0.36f),
            ],
            //千手:一竖为身,左右各三道外张的短臂
            [nameof(MeiSenju)] = [
                L(0.15f, 0.00f, -0.80f, 0.00f, 0.74f),
                L(0.08f, -0.02f, -0.42f, -0.62f, -0.66f),
                L(0.08f, 0.02f, -0.42f, 0.62f, -0.66f),
                L(0.08f, -0.02f, -0.08f, -0.78f, -0.14f),
                L(0.08f, 0.02f, -0.08f, 0.78f, -0.14f),
                L(0.08f, -0.02f, 0.26f, -0.66f, 0.44f),
                L(0.08f, 0.02f, 0.26f, 0.66f, 0.44f),
            ],
            //默切:错位两半压低+沉点
            [nameof(MeiMokukiri)] = [
