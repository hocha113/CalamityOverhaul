...
{
    /// <summary>kikasa.000，沉宴头一关：史莱姆王</summary>
    internal sealed class ShenyoKingSlimeGift : ShenyoBossGiftNarrative, ILocalizedModType
    {
        ...
        public override void SetStaticDefaults() {
            L0 = this.GetLocalization(nameof(L0), () => "这也配称王？");
            L1 = this.GetLocalization(nameof(L1), () => "浑身软趴趴的，倒是挺能蹦");
            L2 = this.GetLocalization(nameof(L2), () => "往后碰上真正难缠的，别学它虚张声势");
        }
        ...
        protected override bool IsGiftCompleted() => ShenyoStorySync.GiftStory.KingSlimeGift;

        protected override void MarkGiftCompleted() => ShenyoStorySync.GiftStory.KingSlimeGift = true;
    }
}
