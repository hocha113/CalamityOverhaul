...
namespace CalamityOverhaul.Content.Scenarios.Dungeonworld.Fog
{
    ...
    /// </summary>
    public static class FogSuppression
    {
        ...
        /// <summary>
        /// 圆形压雾。<paramref name="worldCenterPx"/> 圆心（世界px），<paramref name="radiusPx"/> 全抑制半径，
        ...
        /// <summary>矩形压雾（安全屋/排雾机关用）。<paramref name="worldRectPx"/> 世界px矩形</summary>
        ...
        /// <summary>抑制因子：1=无抑制，0=全压；多请求取最小，边缘 smoothstep 羽化</summary>
