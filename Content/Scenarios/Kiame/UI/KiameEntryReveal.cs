...
{
    /// <summary>
    /// 落地揭示：加载屏是硬切，直接亮起来会露馅。这里从全黑淡出，中途透一层湿青水气，
    /// 让"入雨睁眼"这一下有个过渡。<br/>
    /// 真正的入场演出是雨本身，这层只负责接住加载屏最后那一帧
    /// </summary>
    internal class KiameEntryReveal : ModSystem
    {
        ...
        /// <summary>进世界时由 <see cref="KiameAmbience"/> 上膛</summary>
        ...
        public override void PostDrawInterface(SpriteBatch spriteBatch) {
            ...
            //黑与亮之间透一层湿青：从雨里睁眼看见的第一色是冷的
            float damp = MathF.Sin(MathHelper.Pi * (1f - t));
            spriteBatch.Draw(px, full, PixelSrc, new Color(38, 52, 56) * (damp * 0.36f));
        }
    }
}
