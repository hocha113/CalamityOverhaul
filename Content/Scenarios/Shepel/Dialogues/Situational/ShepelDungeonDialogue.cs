...
namespace CalamityOverhaul.Content.Scenarios.Shepel.Dialogues.Situational
{
    internal sealed class ShepelDungeonDialogue : ShepelSituationalNarrative
    {
        ...
        protected override void Build(NarrativeComposer n) {
            ...
            switch (v) {
                case 0: n.Say("SHPC", V0_Line1.Value, onEnter: PortraitSerious).Say("SHPC", V0_Line2.Value); break;
                case 1: n.Say("SHPC", V1_Line1.Value, onEnter: PortraitSerious).Say("SHPC", V1_Line2.Value); break;
                case 2: n.Say("SHPC", V2_Line1.Value, onEnter: PortraitSerious).Say("SHPC", V2_Line2.Value, onEnter: PortraitSad); break;
                default: n.Say("SHPC", VNight_Line1.Value, onEnter: PortraitSmirk).Say("SHPC", VNight_Line2.Value, onEnter: PortraitSerious); break;
            }
        }
    }
}
