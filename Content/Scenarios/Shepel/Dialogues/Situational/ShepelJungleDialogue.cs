...
namespace CalamityOverhaul.Content.Scenarios.Shepel.Dialogues.Situational
{
    internal sealed class ShepelJungleDialogue : ShepelSituationalNarrative
    {
        ...
        protected override void Build(NarrativeComposer n) {
            ...
            switch (v) {
                case 0: n.Say("SHPC", V0_Line1.Value, onEnter: PortraitSerious).Say("SHPC", V0_Line2.Value, onEnter: PortraitSmirk); break;
                ...
                default: n.Say("SHPC", VHard_Line1.Value, onEnter: PortraitShocked).Say("SHPC", VHard_Line2.Value, onEnter: PortraitSerious); break;
            }
        }
    }
}
