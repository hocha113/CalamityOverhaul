...
namespace CalamityOverhaul.Content.Items.Accessories
{
    ...
    {
        public override string Texture => CWRConstant.Item_Accessorie + "TheRelicLuxor";
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips) {
            ...
            if (item.CountsAsClass<MeleeDamageClass>() || item.CountsAsClass<TrueMeleeNoSpeedDamageClass>()) {
                cumstops.Text = VaultUtils.Translation(
                    "刀刃的挥舞将发射出炽热的灵魂\n"
                    + "忠！诚！",
        ...
        public void OnIfyTops(List<TooltipLine> tooltips, TooltipLine cumstops) {
            ...
            TooltipLine newLine1 = new TooltipLine(Mod, "Assmt", VaultUtils.Translation(
                "投掷出高速弹跳的耀界之灵",
                "Hurl the Spirit of Glory with a high speed bounce"
                )
                ) {
            ...
            TooltipLine newLine2 = new TooltipLine(Mod, "Assmt", VaultUtils.Translation(
                "枪口将迸发出耀界闪电",
                "The muzzle of the gun will burst forth lightning"
                )
                ) {
            ...
            TooltipLine newLine3 = new TooltipLine(Mod, "Assmt", VaultUtils.Translation(
                "散落的魔力将凝聚为金源炸弹",
                "The scattered magic will condense into the gold source bomb"
                )
                ) {
            ...
            TooltipLine newLine4 = new TooltipLine(Mod, "Assmt", VaultUtils.Translation(
                "召唤泛金能量体为你而战",
                "Summon Pangold Energies to fight for you"
                )
                ) {
            ...
            TooltipLine newLine5 = new TooltipLine(Mod, "Assmt", VaultUtils.Translation(
                "刀刃的挥舞将发射出炽热的灵魂\n"
                + "\"忠！诚！\"",
                "The wave of the blade will emit a fiery soul\n"
                + "\"Loyal! !\""
