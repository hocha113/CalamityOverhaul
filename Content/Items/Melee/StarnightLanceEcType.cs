...
namespace CalamityOverhaul.Content.Items.Melee
{
    internal class StarnightLanceEcType : EctypeItem
    {
        ...
        public override void SetDefaults() {
            Item.SetItemCopySD<StarnightLance>();
            Item.SetKnifeHeld<StarnightLanceHeld>();
        }
    ...
    internal class RStarnightLance : BaseRItem
    {
        ...
        public override bool? Shoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source
            , Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
            return StarnightLanceEcType.ShootFunc(item, player, source, position, velocity, type, damage, knockback);
        }
    }
