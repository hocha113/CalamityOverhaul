...
namespace CalamityOverhaul.Content.Items.Magic
{
    internal class RPlasmaRod : BaseRItem
    {
        ...
        public override string TargetToolTipItemName => "PlasmaRodEcType";
    ...
    internal class PlasmaRodHeld : BaseMagicGun
    {
        public override string Texture => CWRConstant.Cay_Wap_Magic + "PlasmaRod";
        public override int targetCayItem => ModContent.ItemType<PlasmaRod>();
        public override int targetCWRItem => ModContent.ItemType<PlasmaRodEcType>();
