...
//                sb.Draw(GlowAsset.Value, center, null, coreColor * p * 0.5f * glowPulse, 0, GlowAsset.Value.Size() / 2, p * 1.5f, 0, 0);
//                sb.Draw(GlowAsset.Value, center, null, midColor * p * 0.3f * (1 - glowPulse), 0, GlowAsset.Value.Size() / 2, p * 2.0f, 0, 0);
//            }
...
//            if (p <= 0) return;
//            Texture2D pixel = CWRAsset.Pixel.Value;
...
//    {
//        public override string Texture => CWRConstant.Projectile_Magic + "PandemoniumScythe";
...
//        public override bool PreDraw(ref Color lightColor) {
//            Texture2D glow = CWRAsset.Glow.Value;
//            float time = Main.GlobalTimeWrappedHourly;
