...
namespace CalamityOverhaul.Content.Narrative.Scenarios.Draedon.Quest.DeploySignaltowers
{
    internal class ConstructionBlueprintQET : ModItem
    {
        ...
        public override bool? UseItem(Player player) {
            ...
            int combat;
            if (DraedonStorySync.ReadDraedon(d => d.UseConstructionBlueprint, d => d.UseConstructionBlueprint)) {
            ...
            DraedonStorySync.WriteDraedon(
                d => d.UseConstructionBlueprint = true,
                d => d.UseConstructionBlueprint = true);
