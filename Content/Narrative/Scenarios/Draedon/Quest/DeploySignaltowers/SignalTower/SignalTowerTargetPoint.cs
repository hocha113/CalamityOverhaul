...
namespace CalamityOverhaul.Content.Narrative.Scenarios.Draedon.Quest.DeploySignaltowers.SignalTower
{
    /// <summary>信号塔目标点数据</summary>
    public class SignalTowerTargetPoint
    {
        /// <summary>目标点位置(图格坐标)</summary>
        public Point TilePosition { get; set; }

        /// <summary>有效范围(图格单位)</summary>
        public int Range { get; set; }

        /// <summary>是否已完成</summary>
        public bool IsCompleted { get; set; }

        /// <summary>点位索引</summary>
        ...
        /// <summary>检查指定位置是否在范围内(正方形范围判断)</summary>
