...
using CalamityOverhaul.Content.Narrative.Scenarios.SupCal;
...
namespace CalamityOverhaul.Content.Narrative.Scenarios.SupCal.Quest.YharonQuest
{
    ...
    internal sealed class SupCalYharonQuestReward : NarrativeScenario, ILocalizedModType
    {
        ...
        private static bool HasHalibut() {
            try {
                return Main.LocalPlayer.TryGetOverride<HalibutPlayer>(out HalibutPlayer halibutPlayer) && halibutPlayer.HasHalubut;
            } catch {
                return false;
            }
        }
