...
using CalamityOverhaul.Content.Narrative.Scenarios.SupCal.Quest.DoGQuest;
using CalamityOverhaul.Content.Narrative.Scenarios.SupCal.Quest.PallbearerQuest;
using CalamityOverhaul.Content.Narrative.Scenarios.SupCal.Quest.YharonQuest;
...
namespace CalamityOverhaul.Content.Narrative.Scenarios.SupCal
{
    internal sealed class SupCalNarrativeTicker : ModSystem
    {
        ...
        private static void TickSupCalDefeat() {
            ...
            Player player = Main.LocalPlayer;
            if (!player.TryGetOverride<HalibutPlayer>(out HalibutPlayer halibutPlayer) || !halibutPlayer.HeldHalibut) {
                return;
            }
        ...
        private static void TickHelenEpilogue() {
            ...
            Player player = Main.LocalPlayer;
            if (!player.TryGetOverride<HalibutPlayer>(out HalibutPlayer halibutPlayer) || !halibutPlayer.HasHalubut) {
                return;
            }
