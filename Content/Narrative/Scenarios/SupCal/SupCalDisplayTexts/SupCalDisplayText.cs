...
using CalamityOverhaul.Content.Narrative.Scenarios.SupCal.ModifySupCalNPCs;
...
namespace CalamityOverhaul.Content.Narrative.Scenarios.SupCal.SupCalDisplayTexts
{
...
这本书里，每一页都封存着曾让整座城邦陷入死寂的恐怖。");
        ...
        private static void StartEternalBlazingNow() {
            if (Main.LocalPlayer.HasHalibut()) {
                NarrativeRouter.Begin<global::CalamityOverhaul.Content.Narrative.Scenarios.SupCal.End.EternalBlazingNow.EternalBlazingNow>();
            }
            else {
