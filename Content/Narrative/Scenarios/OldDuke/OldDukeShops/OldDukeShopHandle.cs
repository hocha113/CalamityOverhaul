using CalamityOverhaul.Content.Narrative.Scenarios.OldDuke.OceanRaiderses;
...
namespace CalamityOverhaul.Content.Narrative.Scenarios.OldDuke.OldDukeShops
{
    internal class OldDukeShopHandle
    {
        public static void Handle(List<OldDukeShopItem> shopItems) {
            ...
            if (Main.LocalPlayer.Alives()
                && OldDukeStorySync.Read(d => d.OldDukeFindFragmentsQuestCompleted, d => d.OldDukeFindFragmentsQuestCompleted)) {
                //海洋吞噬者
