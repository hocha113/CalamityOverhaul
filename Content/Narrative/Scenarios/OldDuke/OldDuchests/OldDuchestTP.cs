...
using CalamityOverhaul.Content.Narrative.Scenarios.OldDuke.OldDuchests.OldDuchestUIs;
using InnoVault.PRT;
...
namespace CalamityOverhaul.Content.Narrative.Scenarios.OldDuke.OldDuchests
{
    /// <summary>
