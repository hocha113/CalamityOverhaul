...
using Terraria;
using SupCalFirstMet = CalamityOverhaul.Content.Narrative.Scenarios.SupCal.FirstMetSupCal;
    ...
    internal sealed class NarrativeHost : ICWRLoader
    {
        ...
        private static void RegisterPortraits() {
            ...
            PortraitRegistry.Register(NarrativeIds.SupCalShadow)
                .Name(() => Scenarios.SupCal.End.EternalBlazingNow.EternalBlazingNow.Rolename2.Value)
                .Portrait(() => ADVAsset.SupCalsADV[4])
                .AsSilhouette()
