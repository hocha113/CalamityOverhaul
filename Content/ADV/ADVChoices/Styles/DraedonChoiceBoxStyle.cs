...
namespace CalamityOverhaul.Content.ADV.ADVChoices.Styles
{
    ...
    internal class DraedonChoiceBoxStyle : IChoiceBoxStyle
    {
        ...
        /// <summary>终端背景：纵向深藏青渐变+对角线纹理+全息闪烁叠层</summary>
        ...
        /// <summary>不对称边框：顶部双层重线+左侧强调竖条+细右底线+顶部左侧刻痕</summary>
        ...
        /// <summary>右侧刻度尺：等距短竖线，每4格加长，流光缓慢向下循环</summary>
        ...
        /// <summary>四角十六进制读出：随机HEX地址串，每40帧刷新，轻微闪烁</summary>
        ...
        /// <summary>选项悬停时的虚线数据流指示（左侧竖向虚线）</summary>
