...
namespace CalamityOverhaul.Content.ADV.ADVChoices.Styles
{
    ...
    internal class SHPCChoiceBoxStyle : IChoiceBoxStyle
    {
        ...
        /// <summary>降级背景：渐变 + 扫描线 + 简易六角点阵 + 扫掠光带 + 暗角</summary>
