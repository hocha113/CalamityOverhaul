...
namespace CalamityOverhaul.Content.ADV.Scenarios.Abysses.OldDukes
{
    ...
    internal class CampsiteChatDialogue : ADVScenarioBase, ILocalizedModType
    {
        ...
        public override void SetStaticDefaults() {
            ...
            Past_Reflection = this.GetLocalization(nameof(Past_Reflection), () => "我只想守着这片海了，如果那些东西试图从深渊里出来，也就是我拼个彻底复苏身死的时候。");
            ...
            Personal_Past1 = this.GetLocalization(nameof(Personal_Past1), () => "也许真正的我早就死了，现在的只是拥有他记忆的......一只厉鬼？每次死亡都会重启，回到死前的时候");
        ...
        internal class CampsiteChatDialogue_Past : ADVScenarioBase
        {
            ...
            protected override void Build() {
                ...
                AddWithChoices(
                    OldDukeName.Value,
                    Past_Reflection.Value,
                    [
                        new Choice(Choice_BackToMain.Value, BackToMain),
                        new Choice(Choice_EndConversation.Value, EndConversation),
                    ],
                    styleOverride: () => SulfseaDialogueBox.Instance,
                    choiceBoxStyle: ADVChoiceBox.ChoiceBoxStyle.Sulfsea
                );
            ...
            protected override void Build() {
                ...
                AddWithChoices(
                    ...
                    [
                        ...
                        new Choice(Choice_EndConversation.Value, SubChoice_End),
                    ],
                    styleOverride: () => SulfseaDialogueBox.Instance,
                    choiceBoxStyle: ADVChoiceBox.ChoiceBoxStyle.Sulfsea
                );
        ...
        internal class Research_Details : ADVScenarioBase
        {
            ...
            protected override void Build() {
                ...
                AddWithChoices(
                    OldDukeName.Value,
                    Research_Details2.Value,
                    [
                        new Choice(Choice_Research_Back.Value, BackToResearch),
                        new Choice(Choice_BackToMain.Value, BackToMain),
                        new Choice(Choice_EndConversation.Value, EndConversation),
                    ],
                    styleOverride: () => SulfseaDialogueBox.Instance,
        ...
        internal class History_Ruins_Dialogue : ADVScenarioBase
        {
            ...
            protected override void Build() {
                ...
                AddWithChoices(
                    OldDukeName.Value,
                    History_MoreRuins2.Value,
                    [
                        new Choice(Choice_History_Back.Value, BackToHistory),
                        new Choice(Choice_BackToMain.Value, BackToMain),
                        new Choice(Choice_EndConversation.Value, EndConversation),
                    ],
                    styleOverride: () => SulfseaDialogueBox.Instance,
        ...
        internal class Personal_Tea_Dialogue : ADVScenarioBase
        {
            ...
            protected override void Build() {
                ...
                AddWithChoices(
                    ...
                    Personal_Tea2.Value,
                    [
                        new Choice(Choice_Personal_Back.Value, BackToPersonal),
                        new Choice(Choice_BackToMain.Value, BackToMain),
                        new Choice(Choice_EndConversation.Value, EndConversation),
                    ],
                    styleOverride: () => SulfseaDialogueBox.Instance,
