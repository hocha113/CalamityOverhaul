...
{
    /// <summary>内容绘制上下文</summary>
    public class ContentDrawContext
    {
        /// <summary>精灵批次</summary>
        public SpriteBatch SpriteBatch;

        /// <summary>面板矩形区域</summary>
        ...
        /// <summary>是否有立绘</summary>
        public bool HasPortrait;

        /// <summary>立绘数据</summary>
        public PortraitData PortraitData;

        /// <summary>立绘键</summary>
        public string PortraitKey;

        /// <summary>立绘尺寸信息</summary>
        ...
        /// <summary>切换缓动值</summary>
        public float SwitchEase;

        /// <summary>立绘出现缩放</summary>
        public float PortraitAppearScale;

        /// <summary>立绘额外透明度</summary>
        ...
        /// <summary>左侧偏移</summary>
        public float LeftOffset;

        /// <summary>名字顶部偏移</summary>
        public float TopNameOffset;

        /// <summary>文本块Y偏移</summary>
        public float TextBlockOffsetY;

        #endregion

        /// <summary>子类用缩放</summary>
        public float Scale;
    }
}
