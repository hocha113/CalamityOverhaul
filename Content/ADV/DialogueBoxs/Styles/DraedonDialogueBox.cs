...
namespace CalamityOverhaul.Content.ADV.DialogueBoxs.Styles
{
    ...
    internal class DraedonDialogueBox : DialogueBoxBase
    {
        ...
        /// <summary>斜切头像框：右上角削角 + 底部左圆角电路迹线<br/>区别于来电框四角L括号的不规则切面感</summary>
        ...
        /// <summary>头像青绿色辉光（与来电框蓝白色系视觉区分）</summary>
        ...
        /// <summary>名称装饰：`>` 前缀 + 名字下方短横线<br/>区别于来电框频道标签/信号格</summary>
        ...
        /// <summary>虚线分割线，缓慢向右流动<br/>区别于来电框流动实心渐变线</summary>
        ...
        /// <summary>终端背景：纵向渐变（深蓝→深蓝绿）+ 对角线纹理（细45°线）+ 全息闪烁叠层</summary>
        ...
        /// <summary>不对称边框：顶部2层重线 + 左侧4px竖条 + 顶部刻痕 + 细右/底线<br/>来电框对称四角L括号，此处单侧重点边</summary>
        ...
        /// <summary>右侧刻度尺：等距短竖线，每4格加长，流光缓慢向下循环<br/>区别于来电框信号格，偏坐标轴感</summary>
        ...
        /// <summary>四角十六进制读出：随机地址串，每40帧刷新，轻微闪烁<br/>替代来电框均衡器条/扇形信号弧</summary>
        ...
        /// <summary>头像框左下角电路迹线（L形小装饰，区别于来电框右上角的脉冲弧线）</summary>
