...
{
    internal class RTheUndertaker : BaseRItem
    {
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips) => CWRUtils.OnModifyTooltips(CWRMod.Instance, tooltips, CWRLocText.GetText("Wap_TheUndertaker_Text"));
    }
}
