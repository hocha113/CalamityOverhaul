...
namespace CalamityOverhaul.Content.RemakeItems.Melee
{
    internal class RBalefulHarvester : BaseRItem
    {
        ...
        public override bool? AltFunctionUse(Item item, Player player) => BalefulHarvesterEcType.AltFunctionUseFunc(item);
        public override void HoldItem(Item item, Player player) => BalefulHarvesterEcType.HoldItemFunc(item);
